...
class MoneyTest < Minitest::Test
  ...
  def test_amount
    ...
    assert_equal 14,  Mint.money(14, Mint.currency_for('PEN')).amount
  end
  ...
  def test_zero
    zero_soles = Mint.money(0r, Mint.currency_for('PEN'))
  ...
  def test_nonzero
    two_soles = Mint.money(2, Mint.currency_for('PEN'))
  ...
  def test_creation
    assert Mint::Money.new(3, Mint.currency_for('PEN'))
    assert_raises(ArgumentError) { Mint::Money.create('334.2', Mint.currency_for('PEN')) }
  ...
  def test_from_fractional
    ...
    assert_equal Mint.money(1, 'USD'),
                 Mint::Money.from_fractional(100, Mint.currency_for('USD'))
  end
